...
typedef struct VirtIOScifPCI VirtIOScifPCI;
...
/*
 * virtio-scif-pci: This extends VirtioPCIProxy.
 */
#define TYPE_VIRTIO_SCIF_PCI "virtio-scif-pci"
#define VIRTIO_SCIF_PCI(obj) \
        OBJECT_CHECK(VirtIOScifPCI, (obj), TYPE_VIRTIO_SCIF_PCI)

struct VirtIOScifPCI {
    VirtIOPCIProxy parent_obj;
    VirtScif vdev;
};
